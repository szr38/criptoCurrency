...
const infotemp: criptomoneyInterface = { amount: -1300, transaction: 'cod-EcteQ', day: new Date, quantityCripto: 0.3, typeMoney: 1 }

const infotemp1: criptomoneyInterface = { amount: -2166.667, transaction: 'cod-CzDe3', day: new Date, quantityCripto: 0.5, typeMoney: 2}

const infotemp2: criptomoneyInterface = { amount: -5128.973, transaction: 'cod-nFzzI', day: new Date, quantityCripto: 1.3, typeMoney: 1 }
